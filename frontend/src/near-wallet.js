...
import WelldoneWalletIconUrl from '@near-wallet-selector/welldone-wallet/assets/welldone-wallet.png';
  ...
  async startUp() {
    this.walletSelector = await setupWalletSelector({
      ...
      modules: [
        ...
        setupWelldoneWallet({ iconUrl: WelldoneWalletIconUrl }),
        setupLedger({ iconUrl: LedgerIconUrl }),
        setupNearFi({ iconUrl: NearFiIconUrl }),
        setupCoin98Wallet({ iconUrl: Coin98WalletIconUrl }),
        setupOptoWallet({ iconUrl: OptoWalletIconUrl }),
        setupNeth({}),
      ],
    });
